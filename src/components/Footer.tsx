            ...
            <div className="mt-6">
              ...
              {footerSubmitted ? (
                ...
                <form onSubmit={handleFooterSubmit} className="flex gap-2">
                  ...
                  <button
                    type="submit"
                    className="px-3 py-2 text-sm font-semibold text-white bg-primary-500 hover:bg-primary-600 rounded-lg transition-colors duration-200 focus-visible:ring-2 focus-visible:ring-primary-500 focus-visible:ring-offset-2 whitespace-nowrap"
