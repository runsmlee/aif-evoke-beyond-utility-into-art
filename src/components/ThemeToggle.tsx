  ...
  return (
    ...
    >
      ...
      <svg
        ...
        className={`transition-all duration-300 ${theme === "dark" ? "scale-100 opacity-100" : "absolute scale-50 opacity-0"}`}
        aria-hidden="true"
      >
      ...
      <svg
        ...
        strokeLinecap="round"
        strokeLinejoin="round"
        className={`transition-all duration-300 ${theme === "light" ? "scale-100 opacity-100" : "absolute scale-50 opacity-0"}`}
        aria-hidden="true"
      >
